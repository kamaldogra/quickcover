 ...
 * @return {Object} - this
 */
function _samanthamorelColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_samanthamorelColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_samanthamorelColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_samanthamorelColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _samanthamorelColor object.
 *
 * @since Twenty Twenty 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function samanthamorelColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _samanthamorelColor( backgroundColor, accentHue );
